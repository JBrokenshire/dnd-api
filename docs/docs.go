...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/characters/{id}/inventory-item/{inventoryItemId}": {
            "put": {
                ...
                "tags": [
                    "Character Inventory Item Actions"
                ],
                "summary": "Update character inventory item",
                "operationId": "characters-update-inventory-item",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Character ID",
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.UpdateCharacterInventoryItemRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/classes/{id}/upload/background-image": {
            "post": {
                ...
                "operationId": "classes-upload-background-image",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Class ID",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.CreateSubclassRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/subclasses/{classId}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Search subclasses by name",
                        "name": "search",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/responses.SubclassPaginatedResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
        ...
        "/subclasses/{classId}/{subclassId}/upload/logo": {
            "post": {
                ...
                "tags": [
                    "Subclass File Actions"
                ],
                "summary": "Upload subclass logo",
                "operationId": "subclasses-upload-logo",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Class ID",
    ...
    "definitions": {
        ...
        "requests.CreateSubclassRequest": {
            "type": "object",
            "required": [
                "class_id",
                "name",
        ...
        "requests.UpdateCharacterInventoryItemRequest": {
            "type": "object",
            "properties": {
                "equipped": {
                    "type": "boolean"
        ...
        "responses.SubclassPaginatedResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
