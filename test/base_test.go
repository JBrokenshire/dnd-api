...
func TestMain(m *testing.M) {
	...
	_ = os.Setenv("MOCK_GOOGLE_API", "true")
	_ = os.Setenv("MOCK_BT_API", "true")

	// We should force the environment to be `development` for tests as any API usage should always be mocked.
